            ...
            <div class="row mt-3">
                ...
                <div class="col-md-4 test-grid text-left px-lg-3">
                    <div class="test-info">
                        ...
                        <p>Sophie's chatbot has been so helpfull for me in the last couple of weeks, i can't imagine my life without the amount of help that it gave me.</p>
                ...
                <div class="col-md-4 test-grid text-left px-lg-3">
                    <div class="test-info">
                        ...
                        <p>Sometimes the chatbot doesn't understand excatly my requests, it needs a little improvments but other than that i totally recommond it.</p>
